...
//              hash,
      ...
      console.log( `[kafka-Producer][${cid}] - Message successfully produced, CorrelationId : ${cid}` );
      console.log( `[kafka-Producer][${cid}] - Message successfully produced, body : ${JSON.stringify(Message)}` );
      console.log( `[kafka-Producer][${cid}] - Message successfully produced, hash : ${hash}` );
      return { status: 201, msg: `Message successfully produced KEY: ${cid}] - ` };     
    } catch (err) {      
      console.log(`[kafka-Producer][${cid}] - Could not write message` + err);
